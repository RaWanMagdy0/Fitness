...
import '../../../domain/entity/meal/meals_tabs_entity.dart';
...
MealsTabsResponseModel MealsTabsResponseModelFromJson(String str) =>
    MealsTabsResponseModel.fromJson(json.decode(str));
String MealsTabsResponseModelToJson(MealsTabsResponseModel data) =>
    json.encode(data.toJson());

class MealsTabsResponseModel {
  MealsTabsResponseModel({
    this.categories,
  });

  factory MealsTabsResponseModel.fromJson(Map<String, dynamic> json) {
    return MealsTabsResponseModel(
...
class Categories {
  ...
  MealsTabsEntity toEntity() {
    return MealsTabsEntity(
      id: idCategory ?? '',
      name: strCategory ?? '',
