...
class ExerciseByMuscleAndLevelModel {
  ExerciseByMuscleAndLevelModel({
      this.id, 
      this.exercise, 
  ...
  ExerciseByMuscleAndLevelModel.fromJson(dynamic json) {
    id = json['_id'];
  ...
  ExerciseByMuscleAndLevelEntity toEntity() {
    return ExerciseByMuscleAndLevelEntity(
      id: id,
      exercise: exercise,
