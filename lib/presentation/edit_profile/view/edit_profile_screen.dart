import 'package:fitness_app/presentation/edit_profile/view/widgets/blurred_avatar.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocListener(
      listeners: [
        ...
        // Add listener for profile photo upload
                ...
                whenAnimationFinished: () {
                  setState(() {
                    if (state.user?.photo != null) {
                      _profileImageUrl = state.user!.photo!;
                    }
                  });
                },
              );
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Use the BlurredAvatar component with image upload capability
                BlurredAvatar(
